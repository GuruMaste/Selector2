...
echo "+------------------------------------------------------------------+"
echo "|     you not see me tater                                         |"
echo "|                                                                  |"
echo "|                                                                  |"
echo "|                                                                  |"
echo "|              Bhonethantkyaw-test001                              |"
echo "|                                                                  |"
echo "|                                                                  |"
echo "+------------------------------------------------------------------+"
echo -e "| Telegram Account : ${GREEN}@shineko6 ${NC}|My Phone Number : ${RED}09964905844${NC} |"
echo "+------------------------------------------------------------------+"
echo ""

echo -e "********************************************************************"
echo -e "\e[1;32mPlease choose an option:(Type btk to install selector)\e[0m"
echo -e "********************************************************************"
echo ""
echo "+------------------------------------------------------------------+"
